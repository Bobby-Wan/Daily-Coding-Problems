...
# possible query strings, return all strings in the 
...
def autocomplete(s, queries):
    return [query for query in queries if query.startswith(s)]


def main():
    queries = ['dog', 'dog', 'deer', 'deal']
    string = 'de'
    print(autocomplete(string,queries))
